...
THEORY ListInvariantX IS
  ...
  List_Invariant(Machine(SnakesAndLaddersGame))==(current_position: boardSquare & next_position: NAT & visited_square: seq(boardSquare) & number_moves: NAT & number_snakes_encounter: NAT & number_ladders_encounter: NAT & dice_value_lastthrown: diceValues & dice_value: diceValues)
END
&
